-- Complete database setup script for CDZAi
-- Run this script first to set up all tables, functions, and triggers
...
-- Insert admin users
INSERT INTO users (email, username, is_admin, user_code) VALUES
  ('chemsdine.kachid02@gmail.com', 'cdz', true, '0001'),
  ('chemsdine.kachid@gmail.com', 'cdz', true, '0002'),
  ('chemsdine.kachid5@gmail.com', 'cdz', true, '0003'),
  ('chemskachid993@gmail.com', 'cdz', true, '0004')
